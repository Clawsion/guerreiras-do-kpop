...
export default function HomePage() {
  ...
  return (
    <>
      ...
      {/* ═══ MANIFESTO — HONMOON PORTAL ═══ */}
      <section
        ref={manifestoRef}
        className={`manifesto-section ${manifestoVisible ? "manifesto-in" : ""}`}
        style={{background:"var(--void)"}}
      >
        {/* Dynamic ambient — synced with portal color */}
        <div className="led-ambient-sync"/>

        {/* ═══ HONMOON PORTAL — fullscreen shader ═══ */}
        <div className="honmoon-portal">
          <LedWallShader active={manifestoVisible}/>
        </div>

        {/* ═══ Portal energy arcs — decorative frame ═══ */}
        <div className="portal-arc portal-arc-top"/>
        <div className="portal-arc portal-arc-bottom"/>
        <div className="portal-strand portal-strand-left"/>
        <div className="portal-strand portal-strand-right"/>
        <div className="portal-node portal-node-1"/>
        <div className="portal-node portal-node-2"/>
        <div className="portal-node portal-node-3"/>
        <div className="portal-node portal-node-4"/>
        <div className="portal-node portal-node-5"/>
        <div className="portal-node portal-node-6"/>
